...
/* { dg-warning "no valid memory region at address 0x100 for SMK_LOCATION metasym 'var_data_bad'" "" { target *-*-* } 0 } */
/* { dg-warning "no valid memory region at address 0x200 for SMK_LOCATION metasym 'var_bss_bad'" "" { target *-*-* } 0 } */
/* { dg-warning "no valid memory region at address 0x300 for SMK_LOCATION metasym 'var_uninit_bad'" "" { target *-*-* } 0 } */
/* { dg-warning "no valid memory region at address 0x400 for SMK_LOCATION metasym 'var_rodata_bad'" "" { target *-*-* } 0 } */
/* { dg-warning "SMK_LOCATION metasym 'var_data_bad' has VMA 0x\[0-9a-f\]+ and has not been placed at address 0x100" "" { target *-*-* } 0 } */
/* { dg-warning "SMK_LOCATION metasym 'var_bss_bad' has VMA 0x\[0-9a-f\]+ and has not been placed at address 0x200" "" { target *-*-* } 0 } */
/* { dg-warning "SMK_LOCATION metasym 'var_uninit_bad' has VMA 0x\[0-9a-f\]+ and has not been placed at address 0x300" "" { target *-*-* } 0 } */
/* { dg-warning "SMK_LOCATION metasym 'var_rodata_bad' has VMA 0x\[0-9a-f\]+ and has not been placed at address 0x400" "" { target *-*-* } 0 } */
...
/* Declare variables in a non-existant memory region.  */
int __attribute__((retain, location(0x100))) var_data_bad = 42;
int __attribute__((retain, location(0x200))) var_bss_bad = 0;
int __attribute__((retain, location(0x300))) var_uninit_bad;
const int __attribute__((retain, location(0x400))) var_rodata_bad = 43;
