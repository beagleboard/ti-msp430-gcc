/* PR 87691 - Test that a union containing __int20__ and a float is not treated as
   20-bits in size.  */

/* { dg-do compile } */
/* { dg-skip-if "no __int20__ for mcpu=msp430" { *-*-* } { "-mcpu=msp430" } { "" } } */
...
/* To move a 20-bit value from memory (using indexed or indirect register
   ...
   size, MOVX.A would be used. No other __int20__ operations are present
