...
int __attribute__((location(0x10000))) high_mem; /* { dg-warning "'-mlarge' is required for placement in upper memory at address '0x10000' with the 'location' attribute" "" { target { ! msp430_large_memory_model } } } */
